...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="content">  
    <form action ="search_document.php" method="post">
    <h1>Search document record</h1>
    ...
    //make the query
    $q = "SELECT document.docId, document.docTitle, document.companyId, document.dateAdd, document.status, client.companyName
    FROM document
    INNER JOIN client ON client.companyId = document.companyId
     WHERE client.companyName like '%$in%'";
    ...
    {
        //Table heading
        echo  '<table width="90%" class="tableInfo">
        <tr>
          <th width="10%">ID</th>
